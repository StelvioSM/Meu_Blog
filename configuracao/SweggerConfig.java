package org.generetion.blogpessoal.configuracao;
...
public class SweggerConfig {
	...
	.basePackage("org.generetion.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		.title("API - Blog Pessoal Smith")
		.description("API Spring - Blog pessoal Stelvio")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/StelvioSM/Meu_Blog")
		.contact(contact())
		.build();
	}
	
	private static Contact contact() {
		return new Contact("Stelvio Smith",
		"https://github.com/StelvioSM",
		"blogpessoalsmith@gmail.com");
	}
